...
const Home: NextPage<{ data: IGetStatusElements }> = ({ data }) => {
  ...
  return (
    ...
    <div className={styles.container}>
      <Head>
      <meta http-equiv="refresh" content="15; URL=/status"></meta>
      ...
      <main className={styles.main}>
        ...
        <i className="mr-1.5 fa-solid fa-circle-exclamation mt-5"></i>Arika'nın Tüm Servis Durumlarını Görüntüleyebilirsiniz. Sistem otomatik olarak çalışır ve her 15 saniyede yenilenir.
        </p>
